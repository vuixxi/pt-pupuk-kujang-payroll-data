...
### Diperbaiki
- Mengoptimalkan tampilan table
  - `summary.html`
  - `variables.css`, `themes.css`, `main.css`, `summary.css`
  - `mainTable.js`, `summaryTable.js`
...
### Diperbaiki
- `login.html`
- `index.css`, `workspace.css`
- `init.js`, `components.js`, `login.js`, `workspace.js`
